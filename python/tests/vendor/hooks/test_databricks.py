...
from reusable_job_cluster.vendor.hooks.databricks import (
    GET_RUN_ENDPOINT,
    SUBMIT_RUN_ENDPOINT,
    DatabricksHook,
    RunState,
)
from reusable_job_cluster.vendor.hooks.databricks_base import (
...
class TestDatabricksHook:
    ...
    def test_do_api_call_retries_with_retryable_error(self):
        ...
        for exception in [
            ...
            with mock.patch("reusable_job_cluster.vendor.hooks.databricks_base.requests") as mock_requests:
    ...
    @mock.patch("reusable_job_cluster.vendor.hooks.databricks_base.requests")
...
class TestDatabricksHookAsyncMethods:
    ...
    @pytest.mark.asyncio
    @mock.patch("reusable_job_cluster.vendor.hooks.databricks_base.aiohttp.ClientSession.get")
    ...
    @pytest.mark.asyncio
    @mock.patch("reusable_job_cluster.vendor.hooks.databricks_base.aiohttp.ClientSession.patch")
...
class TestDatabricksHookAsyncAadToken:
    ...
    @pytest.mark.asyncio
    @mock.patch("reusable_job_cluster.vendor.hooks.databricks_base.aiohttp.ClientSession.get")
    @mock.patch("reusable_job_cluster.vendor.hooks.databricks_base.aiohttp.ClientSession.post")
