...
from reusable_job_cluster.vendor.hooks.databricks_base import BaseDatabricksHook
...
ME_ENDPOINT = ("GET", "api/2.0/preview/scim/v2/Me")
MKDIR_ENDPOINT = ("POST", "api/2.0/workspace/mkdirs")
IMPORT_ENDPOINT = ("POST", "api/2.0/workspace/import")
EXPORT_ENDPOINT = ("GET", "api/2.0/workspace/export")
...
class DatabricksHook(BaseDatabricksHook):
    ...
    def do_mkdirs(self, path: str) -> None:
        json = {"path": path}
        self._do_api_call(MKDIR_ENDPOINT, json)

    def get_current_user(self) -> dict[str, Any]:
        return self._do_api_call(ME_ENDPOINT)

    def do_import_notebook(self, path: str, content_b64: str, overwrite: bool = True,
                           format: str = "SOURCE", language: str = "PYTHON") -> None:
        json = {
            "format": format,
            "path": path,
            "language": language,
        ...
        self._do_api_call(IMPORT_ENDPOINT, json)

    def do_export_notebook(self, path: str, format: str = "SOURCE") -> str:
        json = {
            "format": format,
            "path": path,
        }
