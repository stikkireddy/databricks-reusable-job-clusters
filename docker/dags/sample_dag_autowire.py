...
dag = DAG('my_test_databricks_dummy_dag_autowire', default_args=default_args, schedule_interval=None)
...
# auto wire automatically the tasks to the DatabricksSubmitRunOperator
